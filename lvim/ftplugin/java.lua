...
-- Detect if are you in Linux or MacOs
local os_config = "linux"
if vim.fn.has "mac" == 1 then
  os_config = "mac"
end

-- nvim-jdtls capabilities
local capabilities = require("lvim.lsp").common_capabilities()
local extendedClientCapabilities = jdtls.extendedClientCapabilities
extendedClientCapabilities.resolveAdditionalTextEditsSupport = true

-- Supporting debugging and testing bundles
local bundles = {}
...
dap.configurations.java = {
    ...
    -- Trying launch class
    {
        ...
        mainClass = function()
            ...
            local main_class = vim.fn.input('Main class: ', path .. '/')
            if main_class ~= '' then
                return main_class
            else
                return nil
